            ...
            try:
                if stream == "news":
                    ...
                    if (
                        state.cursor
                        and page.has_more
                        and page.next_cursor == state.cursor
                    ):
                        raise EtlCursorResetRequired(
                            "macrolens_etl_cursor_did_not_advance"
                        )
                    ...
                    if (
                        state.cursor
                        and calendar_page.has_more
                        and calendar_page.next_cursor == state.cursor
                    ):
                        raise EtlCursorResetRequired(
                            "macrolens_etl_cursor_did_not_advance"
                        )
                ...
                # same cursor every scheduled tick.
                if (
