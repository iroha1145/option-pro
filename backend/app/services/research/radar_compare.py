...
def compare_radar_candidates(
    ...
    labeled = attach_timing_candidates(dataset, list(events))
    raw_close = [
    ...
    return {
        ...
        "t1": evaluate_timing_variant(dataset, labeled, variant_key="t1", entry_lag=1),
        "t2": evaluate_timing_variant(dataset, labeled, variant_key="t2", entry_lag=2),
