...
const KNOWN_TYPE_DISCRIMINANTS = new Set([
  'components/detail/api.ts:499 数据不足',
  'components/detail/api.ts:501 偏多',
  'components/detail/api.ts:503 偏空',
  'components/detail/api.ts:504 中性',
  // 等待占位哨兵：对照后端落库的中文字面量，绝不能 __t（译文永不命中，防御失效）
  'components/catalysts/api.ts:152 中文标题等待生成',
  'components/catalysts/api.ts:152 中文摘要等待生成',
  'components/catalysts/api.ts:152 热点标题等待中文分析',
