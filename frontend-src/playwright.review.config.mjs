...
export default defineConfig({
  ...
  testMatch: ['ui-review.spec.mjs', 'options-redesign.spec.mjs', 'feedback-layout.spec.mjs', 'overlay-behavior.spec.mjs', 'smart-drawings.spec.mjs', 'screener-tooltips.spec.mjs', 'appearance.spec.mjs'],
