          ...
          >
            ...
            >
              <span className="flex items-center gap-2.5">
                ...
                <LiveChange symbol={r.ticker} fallback={r.changePct} fallbackAt={r.priceAsOf ?? r.dailyDataThrough} size="sm" />
                <Icon
                  name="chevron-down"
                  size={14}
              ...
              <span className="mt-3 flex items-end justify-between gap-3">
                ...
                <span className="pb-0.5 text-right">
                  <span className="block metric-value text-data-m text-ink-800 tnum"><LivePrice symbol={r.ticker} fallback={r.price} fallbackAt={r.priceAsOf ?? r.dailyDataThrough} /></span>
                </span>
              </span>
              <span
