...
const THEME_TEMPLATES: Record<string, NewsTpl[]> = {
  'theme-ai-capex': [
    ...
    { t: '先进封装产能吃紧，{t} 交付周期拉长引关注', s: '渠道消息称先进封装产能持续紧张，{t}部分型号交付周期延长，市场关注产能爬坡节奏对季度出货的影响。', dir: 'neutral' },
  ...
  'theme-megacap-earnings': [
    ...
    { t: '监管压力再起，{t} 面临新一轮反垄断听证', s: '立法者要求{t}就平台竞争行为出席听证，市场关注潜在的业务拆分风险与合规成本上升。', dir: 'bearish' },
  ...
  'theme-glp1': [
    ...
    { t: '渠道库存水平偏高，{t} 短期出货节奏引关注', s: '渠道调研显示部分区域库存偏高，市场关注{t}短期出货节奏与真实终端需求的匹配度。', dir: 'neutral' },
...
const GENERIC_TEMPLATES: NewsTpl[] = [
  { t: '{t} 盘前异动，成交量放大至日均两倍', s: '市场人士指出，{t}盘前成交明显放大，机构买单集中在开盘前半小时，短线资金关注度快速升温。', dir: 'neutral' },
  ...
  { t: '{t} 管理层变动：CFO 宣布退休，市场关注接班安排', s: '{t}宣布首席财务官将于本季度末退休，公司已启动外部遴选，分析师称过渡风险总体可控。', dir: 'neutral' },
];
...
export function getEconomicCalendar(): EconomicEvent[] {
  const defs: { d: number; h: number; m: number; title: string; impact: EconomicEvent['impact']; f: string; p: string; a: string | null }[] = [
    ...
    { d: 0, h: 8, m: 30, title: 'CPI 月率（10月）', impact: 'high', f: '0.2%', p: '0.3%', a: null },
    { d: 0, h: 21, m: 0, title: '美联储理事沃勒讲话', impact: 'medium', f: '—', p: '—', a: null },
    { d: 1, h: 8, m: 30, title: '初请失业金人数', impact: 'medium', f: '22.5万', p: '22.1万', a: null },
    { d: 1, h: 10, m: 0, title: '密歇根大学消费者信心指数', impact: 'medium', f: '71.0', p: '70.5', a: null },
    { d: 2, h: 8, m: 30, title: 'PPI 月率（10月）', impact: 'medium', f: '0.2%', p: '0.1%', a: null },
    { d: 2, h: 14, m: 0, title: 'FOMC 会议纪要', impact: 'high', f: '—', p: '—', a: null },
    { d: 3, h: 8, m: 30, title: '零售销售月率（10月）', impact: 'high', f: '0.4%', p: '0.6%', a: null },
    { d: 3, h: 21, m: 0, title: '美联储主席鲍威尔讲话', impact: 'high', f: '—', p: '—', a: null },
    { d: 4, h: 0, m: 0, title: '感恩节 · 美股休市', impact: 'holiday', f: '—', p: '—', a: null },
    { d: 5, h: 8, m: 30, title: '非农就业人口变动（11月）', impact: 'high', f: '18.5万', p: '17.2万', a: null },
    { d: 5, h: 8, m: 30, title: '失业率（11月）', impact: 'medium', f: '4.1%', p: '4.1%', a: null },
    { d: 6, h: 10, m: 0, title: 'ISM 制造业 PMI（11月）', impact: 'medium', f: '47.8', p: '47.2', a: null },
  ];
