...
function mapStockDetail(body: unknown): StockDetail {
  ...
  return {
    ...
    change: pickN(r, 'change'),
    changePct: pickN(r, 'changePct', 'change_percent'),
    sparkline: Array.isArray(r.sparkline) ? (r.sparkline as number[]) : [],
    strengthScore: pickN(r, 'strengthScore', 'strength_score'),
    signals: [],
    updatedAt: pickS(r, 'updatedAt', 'as_of') ?? '',
    open: pickN(r, 'open'),
    high: pickN(r, 'high'),
    low: pickN(r, 'low'),
    prevClose: pickN(r, 'prevClose', 'prev_close'),
    volume: pickN(r, 'volume'),
    avgVolume: pickN(r, 'avgVolume', 'avg_volume'),
    marketCap: pickN(r, 'marketCap', 'market_cap'),
    pe: pickN(r, 'pe', 'pe_ratio'),
    ivPercentile: pickN(r, 'ivPercentile', 'iv_percentile'),
    range52w: yearLow !== null && yearHigh !== null ? [yearLow, yearHigh] : null,
