...
export const SCREENER: Dict = {
  ...
  '强弱价差': ['Risk-on spread', 'リスクオン・スプレッド'],
  ...
  '另一组筛选条件正在扫描或冷却，请稍后重试': ['Another set of filters is scanning or cooling down — try again shortly.', '別の条件セットがスキャン中またはクールダウン中です。しばらくしてから再試行してください。'],
  ...
  '清除成交额下限': ['Clear dollar volume floor', '売買代金下限を解除'],
