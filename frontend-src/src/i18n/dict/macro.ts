...
export const MACRO: Dict = {
  ...
  '广义风险收缩': ['Broad-based risk contraction', '全面的なリスクオフ'],
  ...
  '融资分化度（21 日）': ['Funding dispersion (21-day)', 'ファンディング分断度（21日）'],
  '30 年−10 年期限斜率': ['30Y−10Y term slope', '30年−10年ターム・スロープ'],
  '10 年期利率波动（21 日）': ['10Y yield volatility (21-day)', '10年金利ボラティリティ（21日）'],
  ...
  '全国金融条件指数': ['National Financial Conditions Index (NFCI)', '全米金融環境指数（NFCI）'],
  '高收益债相对强度': ['High-yield credit relative strength', 'ハイイールド債の相対強度'],
  '投资级债相对强度': ['Investment-grade credit relative strength', '投資適格債の相対強度'],
  '区域银行相对大盘': ['Regional banks vs. the broad market', '地方銀行の対市場相対強度'],
  'VIX 波动率': ['VIX volatility', 'VIXボラティリティ'],
  'VIX 期限结构': ['VIX term structure', 'VIX期間構造'],
  '风险资产相对避险资产': ['Risk assets vs. safe havens', 'リスク資産の対安全資産相対強度'],
  '高贝塔偏好': ['High-beta preference', '高ベータ選好'],
  '美元广义指数': ['Broad dollar index', '米ドル広義指数'],
  '美元已实现波动（63 日）': ['Dollar realized volatility (63-day)', '米ドル実現ボラティリティ（63日）'],
