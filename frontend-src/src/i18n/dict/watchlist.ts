...
export const WATCHLIST: Dict = {
  ...
  "保存后自选列表将为空。": ["Saving will leave your watchlist empty.", "保存するとウォッチリストは空になります。"],
  "新增 {add} · 移除 {remove}": ["Add {add} · Remove {remove}", "追加 {add} · 削除 {remove}"],
  "正在保存…": ["Saving…", "保存中…"],
  "保存自选": ["Save watchlist", "ウォッチリストを保存"],
  ...
  "自选列表返回异常，请重试": ["Invalid watchlist response. Please retry.", "ウォッチリストデータの応答が正しくありません。再試行してください。"],
  "自选修改尚未确认，请重试": ["Watchlist changes could not be confirmed. Please retry.", "ウォッチリストの変更を確認できませんでした。再試行してください。"],
  ...
  "登录后加入自选": ["Sign in to add to watchlist", "ログインしてウォッチリストに追加"],
  "正在读取自选…": ["Loading watchlist…", "ウォッチリストを読み込み中…"],
  "重试读取自选": ["Retry watchlist", "ウォッチリストの読み込みを再試行"],
  ...
  /* ---------------- 增删自选：toast ---------------- */
  '移出自选': ['Remove from watchlist', 'ウォッチリストから削除'],
  '已加入自选': ['Added to watchlist', 'ウォッチリストに追加しました'],
  '加入失败': ['Failed to add', '追加に失敗しました'],
  '请稍后再试': ['Please try again shortly.', 'しばらくしてから再試行してください。'],
  '已移出自选': ['Removed from watchlist', 'ウォッチリストから削除しました'],
  '移除失败': ['Failed to remove', '削除に失敗しました'],

  /* ---------------- 强制刷新流程：toast ---------------- */
  "正在更新自选行情与评分": ["Updating watchlist quotes and scores", "ウォッチリストの株価とスコアを更新中"],
  '刷新任务未能启动': ['The refresh job failed to start', '更新ジョブを開始できませんでした'],
  '自选已更新': ['Watchlist updated', 'ウォッチリストを更新しました'],
  '已读取最新行情数据': ['Latest quotes loaded', '最新の相場データを取得しました'],
  '自选刷新失败': ['Watchlist refresh failed', 'ウォッチリストの更新に失敗しました'],
