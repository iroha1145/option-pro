...
export const SECTORS: Dict = {
  ...
  '评分覆盖': ['Score coverage', 'スコアカバレッジ'],
  '评分截至': ['Scores through', 'スコア基準日'],
  '评分截至 {date}': ['Scores through {date}', 'スコア基準日 {date}'],
  '有评分 {scored} / {total}': ['Scored {scored} / {total}', 'スコアあり {scored} / {total}'],
  '评分已过期': ['Scores are stale', 'スコア期限切れ'],
  '评分不可用': ['Scores unavailable', 'スコア利用不可'],
  ...
  '等待更新': ['Waiting', '更新待ち'],
  '正在更新': ['Updating', '更新中'],
  '{n} 秒后可更新': ['Update available in {n}s', '{n}秒後に更新できます'],
  '重新更新': ['Update again', '再度更新'],
  '更新已排队，完成后会自动显示': ['Update queued. New results will appear automatically.', '更新を受け付けました。完了後に自動で表示します。'],
  '正在获取新的 IV 数据': ['Getting new IV data.', '新しい IV データを取得しています。'],
  '更新较频繁，请等待 {n} 秒': ['Please wait {n}s before updating again.', '再度更新するまで{n}秒お待ちください。'],
  '更新失败，仍显示上次结果': ['Update failed. Showing the previous result.', '更新に失敗したため、前回の結果を表示しています。'],
  '更新失败，请重试': ['Update failed. Please try again.', '更新に失敗しました。もう一度お試しください。'],
  '未能开始更新，仍显示上次结果': ['The update could not start. Showing the previous result.', '更新を開始できなかったため、前回の結果を表示しています。'],
  '未能开始更新，请重试': ['The update could not start. Please try again.', '更新を開始できませんでした。もう一度お試しください。'],
  '正在确认最新结果': ['Checking the latest results', '最新の結果を確認中'],
  '数据时间 {time}': ['Data as of {time}', 'データ時点 {time}'],
  '数据时间暂缺': ['Data time unavailable', 'データ時刻なし'],
  '读取最新结果失败，仍显示上次数据': ['Could not check the latest result. Showing previous data.', '最新の結果を確認できなかったため、前回のデータを表示しています。'],
  '正在准备该板块的 IV 数据，完成后会自动显示': ['Preparing IV data for this sector. It will appear automatically.', 'このセクターの IV データを準備しています。完了後に自動で表示します。'],
  '该板块成分暂无可用的期权样本，可切换板块或更新数据': ["This sector has no usable options samples yet. Try another sector or update the data.", 'このセクターには利用できるオプションデータがまだありません。別のセクターに切り替えるか、データを更新してください。'],
  ...
  '部分板块数据已过期，请结合各项数据日期查看。': [
    ...
    '一部のセクターデータは期限切れです。各指標の日付をご確認ください。',
  ],
